...
func main() {
	ips := []string{"172.30.25.129", "172.30.233.59", "172.30.189.207", "172.30.55.146", "172.30.144.43", "172.30.189.202", "172.30.55.184", "172.30.25.143", "172.30.25.174", "172.30.189.197", "172.30.25.187", "172.30.55.144", "172.30.144.26"}
	for _, ip := range ips {
		fmt.Printf("ip %v in cidr %v: %v\n", ip, cidr, cidrContains(cidr, ip))
	}
}
